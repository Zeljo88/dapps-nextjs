...
export const metadata: Metadata = {
  title: { default: "DApps on Cardano — Track 107+ DApps, TVL, Volume & Yields", template: "%s | DApps on Cardano" },
  description: "Track 107 Cardano DApps with real-time TVL, DEX volume, transaction counts and yield rates. Compare Minswap, Liqwid, SundaeSwap and more — updated every 5 minutes.",
  ...
  openGraph: {
    title: "DApps on Cardano — Track 107+ DApps, TVL, Volume & Yields",
    description: "Track 107 Cardano DApps with real-time TVL, DEX volume, transaction counts and yield rates. Compare Minswap, Liqwid, SundaeSwap and more.",
  ...
  twitter: {
    ...
    description: "Track TVL, volume, yields and transactions for 107 Cardano DApps. Updated every 5 minutes.",
  },
