        ...
        <div style={{ display: "flex", gap: 20, alignItems: "flex-start", flexWrap: "wrap" }}>
          ...
          <div style={{ flex: 1, minWidth: 200 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 8 }}>
              ...
              {dapp.github && (
                <a href={dapp.github} target="_blank" rel="noopener noreferrer"
                  style={{ fontSize: 12, fontWeight: 600, color: "#9ca3af", padding: "2px 10px",
                    border: "1px solid #9ca3af40", borderRadius: 999, background: "#9ca3af10",
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
              ...
              {dapp.github && (
                <a href={dapp.github} target="_blank" rel="noopener noreferrer" style={{ ...linkStyle, borderColor: "#6e768140" }}>
